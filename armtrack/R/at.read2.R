...
at.read2<-function(data)
{
  ...
  dd2<-data.frame(dd2,dd$ang,dd$LElbAngle,dd$RElbAngle,dd$LSAngle,dd$RSAngle,dd$LHandPos[,1],dd$LHandPos[,2],dd$LHandPos[,3],
  ...
  names(dd2)<-c("Timestamp","TorsoAngle","LElbAngle","RElbAngle","LSAngle","RSAngle","LHandPosX","LHandPosY","LHandPosZ",
